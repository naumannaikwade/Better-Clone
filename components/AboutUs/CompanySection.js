  ...
  return (
    <>
      {/* First Section - Status Quo */}
         <div  style={{backgroundColor:"white",color:"black",padding:"0px 200px 0px 250px"}}>
      <div className="row">
        <div className="col-6 " style={{paddingRight:"50px"}}>
          ...
          <button className="btn mb-5" style={{height:"64px",width:"225px",marginTop:"32px",padding:"0px 40px",backgroundColor:"#017848",color:"white"}}>Read Vishal's Story</button>
        </div>
        <div className="col-6">
          <img src="media/vishal-mission.jpg" style={{height:"400px",width:"500px",objectFit:"cover",marginTop:"50px",marginBottom:"120px"}}></img>
        </div>
      </div>
    </div>
