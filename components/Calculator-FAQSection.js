    ...
    <div style={{ backgroundColor: "white", color: "black" }}>
      <div className="row my-5">
        ...
        <div className="mb-5 mt-5">
          <h4  style={{fontSize:"38px",marginBottom:"40px"}}>How does a mortgage calculator help me?</h4>
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>
        ...
        <div className="mb-5 mt-5">
          <h4 className="mb-3" style={{fontSize:"38px",marginBottom:"40px"}}>
          ...
          <div className="row">
            ...
            <div className="col-8 px-5">
              <p style={{marginTop:"12px",marginBottom:"12px"}}>Formula for calculating your debt-to-income (DTI) ratio:</p>
              <img src="/media/dti-formula.jpg" style={{ width: "100%" }}></img>

              <p style={{marginTop:"12px",marginBottom:"12px"}}>
                Here’s an example of what calculating your DTI might look like:
              </p>
              <img src="/media/dti-example.jpg" style={{ width: "100%" }} className="mb-5"></img>
            </div>
            <div className="col-2"></div>
          </div>
          ...
          <div className="mt-5 mb-5">
            ...
            <h6 style={{fontSize:"28px",marginTop:"24px",marginBottom:"24px"}}>Formula for calculating monthly mortgage payments</h6>
            <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>
            ...
            <div className="row">
              ...
              <div className="col-8 px-5">
                ...
                <p style={{marginTop:"12px",marginBottom:"12px"}}>Where:</p>
                <ul>
                  ...
                  <li>
                    r is the monthly interest rate <br></br>
                ...
                <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>Here’s a simple example:</p>
                <img
            ...
            <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>This formula assumes a fixed-rate mortgage, where the interest rate remains constant throughout the loan term. And remember, you’ll still need to add on taxes, insurance, utilities, and HOA fees if applicable.</p>
          </div>
        ...
        <div style={{ borderTop: "1px solid black" }}></div>
         ...
         <div className="mb-5 mt-5">
          <h6 className="mb-3" style={{fontSize:"28px",marginTop:"24px",marginBottom:"24px"}}>How to use this mortgage calculator?</h6>
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>
        ...
        <div className="mb-5 mt-5">
          <h4 className="mb-3 " style={{fontSize:"38px",marginBottom:"40px"}}>How is Better’s mortgage calculator different?</h4>
          <h6 style={{fontSize:"28px",marginTop:"24px",marginBottom:"24px"}}>This mortgage calculator shows your payments with taxes and insurance</h6>
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>
          ...
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>Your lender will usually require you to have homeowners insurance while you're settling your mortgage. This is a common practice among lenders because they understand that nobody wants to continue paying a mortgage on a home that's been damaged or destroyed.</p>

          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>Here's an interesting fact: Once you fully own your home, the choice to maintain homeowners insurance is entirely up to you. However, to ensure your home is protected against damages caused by fires, lightning strikes, and natural disasters that are common in your area, it is highly recommended to keep it. Therefore, always factor in these costs when using a Mortgage Calculator.</p>

          <h6 style={{fontSize:"28px",marginTop:"24px",marginBottom:"24px"}}>This mortgage calculator shows your mortgage costs with PMI</h6>

          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>PMI, an abbreviation for private mortgage insurance, aids potential homeowners in qualifying for a mortgage without the necessity of a 20% down payment. By opting for a lower down payment and choosing a mortgage with PMI, you can purchase a home sooner, begin accruing equity, and keep cash available for future needs. This can all be calculated using this Mortgage Calculator.</p>
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>Choosing a mortgage with PMI is a popular option: 71% of first-time homebuyers had a down payment of less than 20% in July 2021. In 2020, the median down payment for first-time homebuyers was just 7%, and it hasn’t risen above 10% since 1989.</p>
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>PMI is automatically removed from conventional mortgages once your home equity reaches 22%. Alternatively, you can request the removal of PMI once you've accumulated at least 20% home equity.</p>

          <h6 style={{fontSize:"28px",marginTop:"24px",marginBottom:"24px"}}>This mortgage calculator includes HOA fees</h6>
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>Homeowners association (“HOA”) fees are typically charged directly by a homeowners association, but as HOA fees come part and parcel with condos, townhomes, and planned housing developments, they’re an essential factor to consider when calculating your mortgage costs.</p>
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>Homes that share structural elements, such as roofs and walls, or community amenities like landscaping, pools, or BBQ areas, often require homeowners to pay HOA fees for the maintenance of these shared features. It's important to factor in these costs during your budget planning stage, especially considering that HOA fees typically increase annually. HOAs may also charge additional fees known as ‘special assessments’ to cover unexpected expenses from time to time.</p>
        </div>

         <div style={{ borderTop: "1px solid black" }}></div>

         <div className="mb-5 mt-5">
          <h4 className="mb-3" style={{fontSize:"38px",marginBottom:"40px"}}>How to reduce your monthly mortgage payments?</h4>
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>The lower the purchase price of the home, the lower your loan amount will be. But if the seller is less than willing to cut you a deal, you have other options.</p>
          <h6 style={{fontSize:"28px",marginTop:"24px",marginBottom:"24px"}}>Extend the length of your mortgage</h6>
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>
          ...
          <h6 style={{fontSize:"28px",marginTop:"24px",marginBottom:"24px"}}>Increase your down payment</h6>
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>
          ...
          <h6 style={{fontSize:"28px",marginTop:"24px",marginBottom:"24px"}}>Get a lower interest rate</h6>
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>
        ...
        <div className="mb-5 mt-5">
          ...
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>
           Once again, the easiest way to do this is with a calculator! To know if a home is in your budget, try out our home affordability calculator. This calculator will take a few inputs from you, like income and savings, and let you know the maximum amount of home you can afford.
              ...
              <div className="mb-5 mt-5">
          <h4 className="mb-3" style={{fontSize:"38px",marginBottom:"40px"}}>Next steps to buying a house</h4>
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>
          ...
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>The next step is getting pre-approved. A mortgage pre-approval with Better Mortgage takes as little as 3-minutes and doesn’t impact your credit score. It’s a free, no-commitment way to see how much home you can buy, the mortgages you qualify for, and the range of interest rates you’ll be offered.</p>
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>If you’re ready to buy a home now, our definitive home buying checklist can walk you through everything you need to know to get the home you want. With your Better Mortgage pre-approval letter in hand, you’ll be able to show sellers and real estate agents that you mean business—giving you an edge over homebuyers that don’t have this kind of proof that they’re financially ready to purchase. And by working with an agent from Better Real Estate and funding with Better Mortgage, you’ll save $2,000 on closing costs, and save up to $8,200 on average over the life of your loan.**</p>
        </div>

        <div style={{ borderTop: "1px solid black" }}></div>

<div className="mb-5 mt-5">
          <h4 className="mb-3" style={{fontSize:"38px",marginBottom:"40px"}}>More resources</h4>
         
              {/* card  */}


          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>*See Better Real Estate discount terms and conditions.</p>
          <p className="text-muted" style={{marginTop:"12px",marginBottom:"12px"}}>**The average lifetime savings estimate is based on a comparison of the Freddie Mac Primary Mortgage Market Survey’s (PMMS) 30-year fixed-rate mortgage product with Better Mortgage’s own offered rate for a comparable mortgage product between Jan ‘20 - Dec ‘20. PMMS is based on conventional, conforming fully-amortizing home purchase loans for borrowers with a loan-to-value of 80 percent and with excellent credit. Better Mortgage’s offered rate is based on pricing output for a 30-year fixed-rate mortgage product with a 30-day lock period for a single-family, owner-occupied residential property and a borrower with excellent (760 FICO) credit and a loan-to-value ratio of 80 percent. Individual savings could vary based on current market rates, property type, loan amount, loan-to-value, credit score, debt-to-income ratio and other variables.</p>
        </div>        
